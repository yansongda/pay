...
class Paypal implements ProviderInterface
{
    ...
    {
        $plugin = '\Yansongda\Pay\Shortcut\Paypal\\'.Str::studly($shortcut).'Shortcut';
    ...
    {
        throw new InvalidParamsException(Exception::PARAMS_METHOD_NOT_SUPPORTED, '参数异常: PayPal 不支持 cancel API');
    }
    ...
    {
        throw new InvalidParamsException(Exception::PARAMS_METHOD_NOT_SUPPORTED, '参数异常: PayPal 不支持 close API');
    }
