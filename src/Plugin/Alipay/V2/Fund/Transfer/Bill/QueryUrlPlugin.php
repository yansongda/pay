...
class QueryUrlPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Alipay][Fund][Transfer][Bill][QueryBillUrlPlugin] 插件开始装载', ['rocket' => $rocket]);
        ...
        Logger::info('[Alipay][Fund][Transfer][Bill][QueryBillUrlPlugin] 插件装载完毕', ['rocket' => $rocket]);
