...
class FormatPayloadBizContentPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Alipay][Gateway][FormatPayloadBizContentPlugin] 插件开始装载', ['rocket' => $rocket]);
        ...
        Logger::info('[Alipay][Gateway][FormatPayloadBizContentPlugin] 插件装载完毕', ['rocket' => $rocket]);
