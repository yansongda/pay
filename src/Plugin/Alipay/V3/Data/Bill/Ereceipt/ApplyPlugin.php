...
class ApplyPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Alipay][V3][Data][Bill][Ereceipt][ApplyPlugin] 插件开始装载', ['rocket' => $rocket]);

        $rocket->mergePayload([
            '_method' => 'POST',
            '_url' => '/v3/alipay/data/bill/ereceipt/apply',
            '_body' => $rocket->getParams(),
        ]);

        Logger::info('[Alipay][V3][Data][Bill][Ereceipt][ApplyPlugin] 插件装载完毕', ['rocket' => $rocket]);
