...
class PayPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Douyin][V1][Trade][Pay][PayPlugin] 插件开始装载', ['rocket' => $rocket]);
        ...
        if (is_null($payload)) {
            throw new InvalidParamsException(Exception::PARAMS_NECESSARY_PARAMS_MISSING, '参数异常: 抖音交易系统-小程序下单，参数为空');
        }
        ...
        Logger::info('[Douyin][V1][Trade][Pay][PayPlugin] 插件装载完毕', ['rocket' => $rocket]);
