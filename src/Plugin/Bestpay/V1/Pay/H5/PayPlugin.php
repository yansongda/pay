...
namespace Yansongda\Pay\Plugin\Bestpay\V1\Pay\H5;
...
/**
 * @see https://render.bestpay.cn/open-developers/index.html#/documentCenterLayout/apiDetail?productId=1008&apiPath=/pay/tradeCreate@@1.0@@0 翼支付官方文档（接口详情）
 */
class PayPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Bestpay][V1][Pay][H5][PayPlugin] 插件开始装载', ['rocket' => $rocket]);
        ...
        Logger::info('[Bestpay][V1][Pay][H5][PayPlugin] 插件装载完毕', ['rocket' => $rocket]);
