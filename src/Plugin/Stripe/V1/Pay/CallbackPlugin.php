...
class CallbackPlugin implements PluginInterface
{
    ...
    {
        Logger::debug('[Stripe][V1][Pay][CallbackPlugin] 插件开始装载', ['rocket' => $rocket]);
        ...
        Logger::info('[Stripe][V1][Pay][CallbackPlugin] 插件装载完毕', ['rocket' => $rocket]);
    ...
    protected function init(Rocket $rocket): void
    {
        ...
        if (!$request instanceof ServerRequestInterface) {
            throw new InvalidParamsException(Exception::PARAMS_CALLBACK_REQUEST_INVALID, '参数异常: Stripe 回调参数不正确');
        }
