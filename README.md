...
该文档为 v2.x 版本(目前为 beta 版)，如果您想找 v1.x 版本文档，请点击[https://github.com/yansongda/pay/tree/v1.x](https://github.com/yansongda/pay/tree/v1.x)
...
## 安装
```shell
composer require yansongda/pay:2.0.0-beta -vvv
```
