...
- 支付宝第三方应用授权（ISV 代理商模式）支持：新增 `token_app` 快捷调用（换取/刷新 `alipay.open.auth.token.app`、查询 `alipay.open.auth.token.app.query`），插件归属 `Plugin/Alipay/V2/Open/Authorization`，补充 ISV 授权流程文档 (#1091)
