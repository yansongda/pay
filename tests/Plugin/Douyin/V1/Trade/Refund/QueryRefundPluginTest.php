...
use Yansongda\Pay\Plugin\Douyin\V1\Trade\Refund\QueryRefundPlugin;
...
class QueryRefundPluginTest extends TestCase
{
    ...
    public function testEmptyPayload(): void
    {
        ...
        self::expectExceptionMessage('参数异常: 抖音交易系统-查询退款，参数为空');
    ...
    public function testNormal(): void
    {
        ...
        self::assertEquals('api/trade/v1/query_refund', $payload->get('_url'));
