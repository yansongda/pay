...
class PreRefundCallbackPluginTest extends TestCase
{
    private PreRefundCallbackPlugin $plugin;

    protected function setUp(): void
    {
        parent::setUp();

        $this->plugin = new PreRefundCallbackPlugin();
    }
    ...
    {
        $msg = ['refund_id' => '7398108028895054107', 'need_refund_audit' => true];
        $body = json_encode(['version' => '3.0', 'type' => 'pre_create_refund', 'msg' => json_encode($msg)]);
