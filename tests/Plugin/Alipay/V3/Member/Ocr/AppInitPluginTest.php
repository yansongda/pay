...
use Yansongda\Pay\Plugin\Alipay\V3\Member\Ocr\AppInitPlugin;
...
class AppInitPluginTest extends TestCase
{
    ...
    public function testNormal()
    {
        ...
        self::assertSame('/v3/datadigital/fincloud/generalsaas/ocr/mobile/initialize', $result->getPayload()->get('_url'));
        self::assertSame('DATA_DIGITAL_BIZ_CODE_OCR', $result->getPayload()->get('_body')['biz_code']);
