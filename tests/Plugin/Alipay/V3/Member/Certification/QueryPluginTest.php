...
use Yansongda\Pay\Plugin\Alipay\V3\Member\Certification\QueryPlugin;
...
class QueryPluginTest extends TestCase
{
    ...
    public function testNormal()
    {
        ...
        self::assertSame('/v3/alipay/user/certify/open/query?certify_id=202603250001', $result->getPayload()->get('_url'));
