...
use Yansongda\Pay\Plugin\Alipay\V3\Member\FaceVerification\AppInitPlugin;
...
class AppInitPluginTest extends TestCase
{
    ...
    public function testNormal()
    {
        ...
        self::assertSame('/v3/datadigital/fincloud/generalsaas/face/verification/initialize', $result->getPayload()->get('_url'));
        self::assertSame('DATA_DIGITAL_BIZ_CODE_FACE_VERIFICATION', $result->getPayload()->get('_body')['biz_code']);
        self::assertSame('CERT_INFO', $result->getPayload()->get('_body')['identity_type']);
