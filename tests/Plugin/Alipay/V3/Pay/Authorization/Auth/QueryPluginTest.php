...
use Yansongda\Pay\Plugin\Alipay\V3\Pay\Authorization\Auth\QueryPlugin;
...
class QueryPluginTest extends TestCase
{
    ...
    public function testNormal()
    {
        ...
        self::assertSame('/v3/alipay/fund/auth/operation/detail/query', $result->getPayload()->get('_url'));
    }
}
