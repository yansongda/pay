...
class ModifyPluginTest extends TestCase
{
    ...
    public function testEmptyPayload()
    {
        ...
        self::expectExceptionMessage('参数异常: 修改支付分订单金额，参数缺少 `out_order_no`');
    ...
    {
        $rocket = new Rocket();
        $rocket->setPayload(new Collection(['total_amount' => 200, 'reason' => '测试修改金额']));
    ...
    public function testMissingServiceId()
    {
        ...
        self::expectExceptionMessage('参数异常: 修改支付分订单金额，参数缺少 `service_id`');
    ...
    public function testNormal()
    {
        ...
        self::assertEquals([
            ...
            'reason' => '测试修改金额',
            '_method' => 'POST',
            '_url' => '/v3/payscore/serviceorder/202609100003/modify',
