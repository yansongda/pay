...
class SyncPluginTest extends TestCase
{
    ...
    public function testEmptyPayload()
    {
        ...
        self::expectExceptionMessage('参数异常: 同步支付分订单，参数缺少 `out_order_no`');
    ...
    {
        $rocket = new Rocket();
        $rocket->setPayload(new Collection(['type' => 'Order_Paid']));
    ...
    public function testMissingServiceId()
    {
        ...
        $rocket->setParams(['_config' => 'empty_wechat_public_cert'])->setPayload(new Collection([
            'out_order_no' => '202609100004',
            'type' => 'Order_Paid',
            'detail' => ['paid_time' => '20260910000140'],
        ]));

        self::expectException(InvalidParamsException::class);
        self::expectExceptionCode(Exception::PARAMS_WECHAT_SERVICE_ID_MISSING);
        self::expectExceptionMessage('参数异常: 同步支付分订单，参数缺少 `service_id`');
    ...
    public function testNormal()
    {
        ...
        self::assertEquals([
            ...
            'detail' => ['paid_time' => '20260910000140'],
            '_method' => 'POST',
            '_url' => '/v3/payscore/serviceorder/202609100004/sync',
