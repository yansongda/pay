...
class CompletePluginTest extends TestCase
{
    ...
    public function testEmptyPayload()
    {
        ...
        self::expectExceptionMessage('参数异常: 完结支付分订单，参数缺少 `out_order_no`');
    ...
    {
        $rocket = new Rocket();
        $rocket->setPayload(new Collection(['total_amount' => 100]));
    ...
    public function testMissingServiceId()
    {
        ...
        $rocket->setParams(['_config' => 'empty_wechat_public_cert'])->setPayload(new Collection([
            'out_order_no' => '202609100002',
            'total_amount' => 100,
        ]));

        self::expectException(InvalidParamsException::class);
        self::expectExceptionCode(Exception::PARAMS_WECHAT_SERVICE_ID_MISSING);
        self::expectExceptionMessage('参数异常: 完结支付分订单，参数缺少 `service_id`');
    ...
    public function testNormal()
    {
        ...
        $rocket->setPayload(new Collection([
            'out_order_no' => '202609100002',
            'post_payments' => [['name' => '测试商品', 'amount' => 100]],
            'total_amount' => 100,
            'time_range' => ['start_time' => '20260910000140'],
        ]));
        ...
        self::assertEquals([
            ...
            'time_range' => ['start_time' => '20260910000140'],
            '_method' => 'POST',
            '_url' => '/v3/payscore/serviceorder/202609100002/complete',
