...
class PosShortcutTest extends TestCase
{
    ...
    public function testEndToEnd(): void
    {
        ...
        self::assertEquals('https://openapi.alipay.com/v3/alipay/trade/pay', (string) $radar->getUri());

        $requestBody = json_decode((string) $radar->getBody(), true);
        self::assertSame('v3pos1704093802', $requestBody['out_trade_no']);
        self::assertSame('0.01', $requestBody['total_amount']);
        self::assertSame('bar_code', $requestBody['scene']);
        self::assertSame('286958267789018980', $requestBody['auth_code']);
