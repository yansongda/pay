...
class CloseShortcutTest extends TestCase
{
    ...
    public function testCloseHttp(): void
    {
        $body = json_encode([
        ...
        // notify_url 为官方 AlipayTradeCloseModel 独有字段，应随业务参数进入请求 body
        self::assertInstanceOf(Request::class, $captured);
        $requestBody = json_decode((string) $captured->getBody(), true);
        self::assertEquals('https://pay.yansongda.cn/alipay/notify', $requestBody['notify_url']);
